...
const SLIDES = [
  {
    bg: "slide-bg-1",
    title: ["LA RÉFÉRENCE DES ", "COACHS"],
    text: "Exercices, systèmes et séances prêts à l'emploi.",
  },
  {
    bg: "slide-bg-2",
    title: ["CRÉE TES ", "SYSTÈMES"],
    text: "Un éditeur de schémas pensé pour le terrain.",
  },
  {
    bg: "slide-bg-3",
    title: ["PARTAGE TA ", "PLAQUETTE"],
    text: "Conçois et diffuse tes plaquettes en quelques clics.",
  },
];
        ...
        <section className="hero-slider">
          ...
          >
            {SLIDES.map((slide, index) => (
              <div className={`slide ${slide.bg}`} key={index}>
                <div>
                  <h1>
                    {slide.title[0]}
