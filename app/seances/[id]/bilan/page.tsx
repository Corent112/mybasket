...
export default function SeanceBilanPage() {
  ...
  return (
    <main className="page">
      ...
      {sessionId && (
        <section className="selfEvaluationSection">
          <div className="selfEvaluationIntro">
            <span>AUTO-ÉVALUATION LIÉE À LA SÉANCE</span>
            <h2>Analyse et préparation de la prochaine séance</h2>
            <p>
              Cette partie complète le bilan historique sans le remplacer.
              Elle évalue la maîtrise des exercices et alimente les conseils de la prochaine séance.
            </p>
          </div>
          <SessionSelfEvaluation sessionId={String(sessionId)} />
        </section>
      )}
      ...
      <style jsx>{`
        ...
        .selfEvaluationIntro span {
          color: #d4a24c;
          font-size: 11px;
          font-weight: 950;
          letter-spacing: 1.2px;
        }
        .selfEvaluationIntro h2 {
          margin: 5px 0;
          color: #7a0d24;
        }
        .selfEvaluationIntro p {
          margin: 0;
          color: #75666a;
          line-height: 1.5;
        }
