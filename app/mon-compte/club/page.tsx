    ...
    return (
      <main style={{ padding: 32, background: "#f6f2ec", minHeight: "100vh" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <Link href="/mon-compte" style={{ color: "#6b1a2c", fontWeight: 900, textDecoration: "none" }}>← Retour Mon Compte</Link>
          <section style={{ marginTop: 18, background: "linear-gradient(135deg,#6b1a2c,#35101a)", color: "#fff", borderRadius: 24, padding: 28 }}>
            ...
            <p style={{ margin: 0, opacity: .88 }}>Crée d’abord ton espace club. Tu pourras ensuite ajouter tes équipes, joueurs, staff, planning, documents et outils de gestion.</p>
          </section>
          <section style={{ marginTop: 14, background: "#fff", border: "1px solid #eadfd8", borderRadius: 18, padding: 22 }}>
            ...
            <p style={{ color: "#766860" }}>{error || "Comme pour l’espace Institutionnel, commence par créer ta structure. Ton compte sera automatiquement enregistré comme propriétaire du club."}</p>
            <Link href="/mon-compte/club/creation" style={{ display: "inline-flex", marginTop: 8, background: "#6b1a2c", color: "#fff", padding: "11px 16px", borderRadius: 10, fontWeight: 950, textDecoration: "none" }}>+ Créer mon club</Link>
          </section>
        </div>
      </main>
    );
