...
export default async function AdminServiceRequestsPage({
  ...
  const serviceRequests = rows.filter((request) => {
    ...
    return (
      service.startsWith("scouting vidéo") ||
      service.includes("scouting") ||
      service.includes("analyse vidéo") ||
      service.includes("analyse video") ||
      ...
      <div className={styles.container}>
        ...
        <header className={styles.header}>
          <div>
            ...
            <p>Gestion des demandes d’analyse vidéo, de scouting adverse et de montage professionnel.</p>
          </div>
        ...
        <section className={styles.workspace}>
          <div className={styles.toolbar}>
            ...
            <form className={styles.filters} method="get">
              ...
              <Link href="/admin/scouting-video" className={styles.resetButton}>
                Réinitialiser
              </Link>
            </form>
          </div>
