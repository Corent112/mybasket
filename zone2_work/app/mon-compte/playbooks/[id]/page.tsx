...
.pb-viewswitch { display: inline-flex; gap: 4px; margin-bottom: 14px; background: #f4eef0; border-radius: 12px; padding: 4px; }
.pb-viewswitch button { border: none; background: transparent; color: #6b5f63; padding: 8px 16px; border-radius: 9px; font-size: 13px; font-weight: 800; cursor: pointer; }
