...
export default async function AdminScoutingVideoPage() {
  const { supabase } = await requireAdmin();
  ...
  const requests = ((data || []) as AccompagnementRequest[]).filter((request) => {
    const service = String(request.service_type || "").toLowerCase();
    return service.includes("scouting") || service.includes("vidéo") || service.includes("video");
  });
      ...
      <div className={styles.container}>
        ...
        <section className={styles.hero}>
          <div>
            ...
            <span>
              Centralise les demandes de scouting vidéo et d’analyse professionnelle.
            </span>
          </div>
        </section>
        ...
        <section className={styles.tableCard}>
          <div className={styles.tableHead}>
            <h2>Demandes de scouting vidéo</h2>
          ...
          <div className={styles.grid}>
            ...
            {requests.length === 0 && (
              <div className={styles.emptyState}>
                Aucune demande de scouting vidéo pour le moment.
              </div>
            )}
          </div>
        </section>
