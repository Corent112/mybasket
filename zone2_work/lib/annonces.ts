...
export const CATEGORIES = ["U13", "U15", "U18", "U21", "Seniors"];
...
export const FORM_SCHEMAS: Record<AdTypeKey, Field[]> = {
  ...
  "camp-stage": [
    ...
    {
      key: "program",
      label: "Journée type / programme de la semaine",
      type: "textarea",
      full: true,
      group: G.content,
    },
    {
      key: "coachesPresent",
      label: "Coachs présents",
      type: "textarea",
      placeholder: "Nom, fonction et expérience des coachs présents",
      full: true,
      group: G.content,
    },
    {
