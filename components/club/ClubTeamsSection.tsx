        ...
        <div className="modalLayer" onClick={() => setTeamForm(null)}>
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="formGrid">
              <label>Nom<input value={teamForm.name} onChange={(e) => setTeamForm({ ...teamForm, name: e.target.value })} placeholder="U15 France" /></label>
              ...
              <label>Coach principal
                <select value={teamForm.coachId} onChange={(e) => setTeamForm({ ...teamForm, coachId: e.target.value })}>
                  ...
                  {coaches.map((coach) => <option key={coach.id} value={coach.userId || coach.id}>{coach.name}</option>)}
                </select>
              </label>
              <label>Assistant
