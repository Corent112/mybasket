  ...
  return (
    <section className="perf">
      ...
      <style jsx>{`
        ...
        .kpis{display:grid;grid-template-columns:repeat(6,1fr);gap:12px;padding:18px}.kpis b{border:1px solid #eadfd5;background:#fff8ee;border-radius:20px;padding:18px;text-align:center;color:var(--club-primary);font-size:1.4rem}.kpis small{display:block;color:#6b7280;font-size:.7rem}
        .layout{display:grid;grid-template-columns:320px 1fr;gap:18px;padding:0 18px 18px}.panel{border:1px solid #eadfd5;border-radius:24px;padding:18px;background:#fff}.panel h3{margin:0 0 14px;color:var(--club-primary)}
        .leader{display:grid;grid-template-columns:44px 1fr auto;gap:10px;align-items:center;padding:12px;border-bottom:1px solid #eef2f7}.leader span{color:var(--club-secondary);font-weight:900}.leader strong{color:#111827}.leader b{color:var(--club-primary)}
