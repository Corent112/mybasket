...
export default function ClubSettingsSection({
  ...
  const [primaryColor, setPrimaryColor] = useState("var(--club-primary)");
  const [secondaryColor, setSecondaryColor] = useState("var(--club-secondary)");
  ...
  return (
    <section className="settings">
      ...
      <style jsx>{`
        ...
        button{border:1px solid #eadfd5;background:var(--club-primary);color:white;border-radius:999px;padding:10px 14px;font-weight:900;cursor:pointer}
        ...
        .layout{display:grid;grid-template-columns:1fr 1.1fr;gap:18px;padding:18px}.panel{border:1px solid #eadfd5;border-radius:24px;padding:18px;background:#fff}.panel h3{margin:0 0 14px;color:var(--club-primary)}
