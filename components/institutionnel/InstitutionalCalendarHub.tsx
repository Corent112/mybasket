...
export default function InstitutionalCalendarHub({structureId,onGoTraining,onGoPlayers}:{structureId:string;onGoTraining:()=>void;onGoPlayers:()=>void}){
 ...
 return <div className="hub">
  ...
  <section className="eventsSection">
   <div className="sectionHead"><div><p>LISTE DES ÉVÉNEMENTS</p><h3>Organisation & documents nécessaires</h3><span>Chaque événement garde sa propre liste : fichier, note, émargement, convocation, scénario pédagogique, présentation…</span></div><label className="pastToggle"><input type="checkbox" checked={showPast} onChange={e=>setShowPast(e.target.checked)}/> Afficher les événements passés</label></div>
