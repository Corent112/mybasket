...
import InstitutionalPlayerImport from "@/components/institutionnel/InstitutionalPlayerImport";
  ...
  return (
    <div className="wf">
      <div className="hero">
        ...
        {tab === "base" && referralUrl ? <div className="heroReferral">
          ...
          <div><b>Signaler un joueur</b><span>Scanne le QR code ou partage le lien</span><div><code>{referralUrl.replace(/^https?:\/\//, "")}</code><button onClick={copyReferralLink}>Copier</button><button className="posterBtn" onClick={()=>setShowReferralPoster(true)}>Générer l’affiche</button></div></div>
      ...
      {tab === "base" && (
        <>
          <section className="baseIntro">
            ...
            <div className="baseActions"><span className="viewHint">Clique sur un joueur pour ouvrir sa fiche complète.</span><button type="button" className="ghost" onClick={() => setShowPlayerImport(true)}>⇧ Importer des joueurs</button><button type="button" onClick={() => setShowCreatePlayer(true)}>+ Ajouter un joueur</button></div>
          </section>
