...
function documentCss(structure: Structure) {
  ...
  return `
    ...
    *{box-sizing:border-box;max-width:100%}body{margin:0;padding:20px;background:linear-gradient(135deg,#f5f0ee,#ebe4e2)}.sheet{position:relative;overflow:hidden;width:min(100%,794px);margin:0 auto;background:#fff;min-height:0;padding:96px 38px 42px;border:0;border-radius:2px;box-shadow:0 18px 60px rgba(54,18,28,.16)}
    ...
    .mb-scenario-head{position:relative;text-align:left;margin:4px 0 12px;padding:11px 14px;background:linear-gradient(125deg,var(--wine),var(--wine));color:#fff;border-radius:11px 11px 24px 11px}.mb-scenario-level{font-size:17px;font-weight:900;color:#fff;margin-bottom:4px}.mb-scenario-theme{border:0;border-top:1px solid rgba(255,255,255,.25);padding:6px 0 0;color:var(--gold);font-size:11px;font-weight:800}.mb-swot{display:grid;grid-template-columns:1fr 1fr;gap:8px}.mb-swot section{border:0;border-left:3px solid var(--gold);background:#fbf7f8;padding:8px;min-height:90px;border-radius:0 9px 9px 0}.mb-practical h1{color:var(--wine);border:0;padding-bottom:5px}
